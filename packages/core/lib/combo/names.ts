...
const ITEM_NAMES: {[k in ItemID]: string} = {
  ...
  OOT_SOUL_NPC_BUSINESS_SCRUBS: 'Soul of Business Scrubs (OoT)',
  ...
  OOT_SOUL_ENEMY_CURSE_SPIDER: 'Soul of Gold Skulltulas',
  OOT_SOUL_BOSS_GANONDORF: 'Soul of Ganondorf',
  MM_SOUL_ENEMY_CURSE_SPIDER: 'Soul of Swamp & Ocean Skulltulas',
